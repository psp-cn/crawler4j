...
public final class UrlResolver {
	...
	setStartIndex(startIndex);
	                               ...
	                               public void autoFixMethod3(int locationEndIndex, Url url, int endIndex, int startIndex)   {
	...
	setUrl(url);
	                               ...
	                               public void autoFixMethod4(int locationEndIndex, Url url, int endIndex, int startIndex)   {
            if ((locationStartIndex >= 0) && (locationEndIndex < 0)) {
                // The substring of characters after the double-slash and up to, but not
...
autoFix3.autoFixMethod3(locationEndIndex, url, endIndex, startIndex);
...
autoFix4.autoFixMethod4(locationEndIndex, url, endIndex, startIndex);
